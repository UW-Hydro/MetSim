...
class Forcing(object):
    ...
    def __init__(self, met_data: xr.Dataset, params: dict):
        """
        Initialize the forcing object.

        Args:
            met_data: A dataset containing given forcings.
    ...
    def _validate_inputs(self, met_data: xr.Dataset, params: dict):
    ...
    def _calc_solar_geom(self):
        ...
        t1 = 1.0 - (consts['LR_STD'] * params['elev'])/consts['T_STD']
